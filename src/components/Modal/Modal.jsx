...
const Modal = ({ closeModal, onSave, taskToUpdate }) => {
    ...
    return (
        <>
            ...
            <div className="absolute top-10 left-1/4 z-10 mx-auto my-10 w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/[36%] bg-[#191D26] p-9 max-md:px-4 lg:my-20 lg:p-11">
                <h2 className="mb-9 text-center text-2xl font-bold text-white lg:mb-11 lg:text-[28px]">{isAdd ? "Add New Task" : "Update Task"}<span className="font-bold absolute top-10 right-10 cursor-pointer hover:scale-125 fond-bold" onClick={closeModal}><RxCross2 color="red" /></span></h2>
                ...
                <div className="mt-16 flex justify-center lg:mt-20 gap-4">
                    ...
                    >{isAdd ? "Add Task" : "Update Task"}</button>
                    <button
                        type="submit"
